...
const HomePeopleSection = (props) => {
	let countryRoute = CountryDetection.myCountry(props);
	return (
		<>
			<section className="section people-section viewport-size backdrop-white has-layer-secondary has-logo-red" id="HomePeople">
				<HomeNavbar {...props} />
								...
								>
									<div className="row justify-content-between align-items-center">
										<Col xs={12} md={5} className="pr-0 primary-panel">
											<h3 className="section-leader has-product-icon icon-people">
											...
											<h2 className="section-heading mb-4">{TranslateText('home.peopleSection.heading')}</h2>
											<p className="section-byline my-4">{TranslateText('home.peopleSection.byline')}</p>
											<p className="section-trailer my-4">
												<a href={`${countryRoute}/people/`} className="btn btn-readmore text-product-people">
													{TranslateText('home.peopleSection.linkText')} →
												</a>
											</p>
										</Col>
										<Col xs={12} md={6} className="pr-md-0 secondary-panel parallax-banner">
											<Parallax className="parallax" y={[-1, 1]} tagOuter="div">
												<img
													src={`/static/images/home-people-section-screenshot@2x.png`}
													alt=""
												...
												<Parallax className="parallax-takeout takeout-two" y={[-10, 30]} x={[0, 0]} tagOuter="div">
													<img
														...
														src={`/static/images/home-people-section-takeout-02@2x.png`}
												...
												<Parallax className="parallax-takeout takeout-one" y={[-10, 30]} x={[0, 0]} tagOuter="div">
													<img
														alt="Compliance Takeout"
														src={`/static/images/home-people-section-takeout-01@2x.png`}
